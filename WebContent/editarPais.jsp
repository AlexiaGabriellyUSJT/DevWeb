                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="populacao" id="fone" maxlength="15" placeholder="população" value="${pais.populacao}" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">Área</label>
                                <input type="number" class="form-control" name="area" id="email" required maxlength="60" placeholder="area" value="${pais.area}">
                            </div>
                        </div>
                        <hr />
